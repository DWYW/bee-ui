...
describe(`\x1b[46m bee-picker \x1b[0m`, () => {
  ...
  describe(`The prop of "timeVisible"`, () => {
    ...
    it(`datetime time items length should be 2`, () => {
      wrapper.setProps({
        type: 'datetime'
      })
    ...
    it(`rangetime time items length should be 4`, () => {
      wrapper.setProps({
        type: 'rangetime'
      })
