...
describe(`\x1b[46m bee-pagination \x1b[0m`, () => {
  ...
  describe(`The prop of "page"`, () => {
    it('the current button will be acitved', () => {
      const wrapper = _createWrapper({
        propsData: {
          pageTotal: 10,
          page: 1
      ...
      expect(wrapper.findAll(".bee-pagination--button").at(1).classes()).to.contain('bee-pagination--button__actived')
      wrapper.setProps({
        page: 2
      })
  ...
  describe(`The prop of "total"`, () => {
    it(`the value is undefined or eq 0, the total will be not exists`, () => {
      const wrapper = _createWrapper({
        propsData: {
          page: 1,
          pageTotal: 10
  ...
  describe(`The prop of "totalVisible"`, () => {
    ...
    it(`the value is false, total tap should be not exists`, () => {
      wrapper.setProps({
        totalVisible: false
      })
      expect(wrapper.find('.bee-pagination--total').exists()).not.ok
